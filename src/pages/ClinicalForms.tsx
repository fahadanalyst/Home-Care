...
export const ClinicalForms: React.FC = () => {
  return (
    <div className="p-8 max-w-7xl mx-auto space-y-8">
      <div>
        <h1 className="text-3xl font-bold text-zinc-900 italic">Clinical Forms</h1>
        <p className="text-zinc-500">Access and complete clinical documentation and assessments</p>
      </div>
